    ...
    <drawer @close="close" v-show="isModalVisible">
        ...
        <template v-slot:body>
            ...
            <div class="ml-5 flex flex-col justify-start content-start">
                ...
                >
                <input
                    class="mt-2 mr-5 p-2 outline-none bg-gray-200 focus:shadow-lg text-primary placeholder-gray-600 rounded"
                    id="mail-suggest"
            ...
            <div class="mt-4 flex justify-center">
                ...
                <p class="mt-2 text-center" v-else>
                    {{ $t('suggest_feature.suggest_limit_message') }}
                </p>
            </div>
        </template>
...
export default {
    ...
    methods: {
        ...
        submitForm() {
            ...
            axios.defaults.baseURL = import.meta.NODE_ENV === 'development' ? 'http://localhost:80' : import.meta.BASE_URL
            ...
            ax.post('/featuresuggests', {
                ...
                .then((response) => {
                    this.buttonLabel =
                        response.status === 201 ? this.$t('suggest_feature.btn_sent_ok') : this.$t('suggest_feature.btn_sent_ko')
