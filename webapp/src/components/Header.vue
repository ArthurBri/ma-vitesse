    ...
    <div class="relative w-full">
        <div class="header">
            <div class="header-start flex flex-row">
                <div class="logo">
                    <img alt="logo" class="noselect-nodrag sm:w-8 md:w-8 lg:w-12 xl:w-12 cursor-pointer" src="../assets/logo.svg" />
...
.header {
    @apply flex items-center fixed bottom-0 justify-between w-full z-30 p-3 text-white;
}
