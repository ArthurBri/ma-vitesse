    ...
    <div class="box">
        <div class="flex w-full sm:flex-col md:flex-col justify-start"
            ...
            <div class="flex flex-col sm:mb-4 md:mb-4 sm:flex-row sm:items-center sm:justify-between md:flex-row md:items-center md:justify-between">
                ...
                <div class="laptime-end flex content-center border border-gray-200  mt-6 sm:mt-0 md:mt-0 py-1 px-1 rounded-lg mr-8 sm:mr-0 md:mr-0">
                ...
                <div @click="switchLaptimeSort"
                     class="mr-8 sm:mr-0 md:mr-0 mt-6 sm:mt-0 md:mt-0 px-2 py-1 border border-gray-200 rounded-lg flex justify-center cursor-pointer noselect-nodrag">
